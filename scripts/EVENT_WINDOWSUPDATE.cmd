:: WINDOWS UPDATE IN THE EVENT VIEWER
...
CURL -k -s -i -H "Accept: application/json" -H "Content-Type:application/json" -X POST  --data "{\"content\": \"[%mydate% %mytime% %~nx0] Windows Update started downloading an update. \"}" %DISCORDWEBHOOK% >NUL
